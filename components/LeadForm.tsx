...
export function LeadForm({
  ...
  const onFocusCapture = () => {
    ...
    try {
      if (!sessionStorage.getItem("bridgelands_detached_form_start")) {
        sessionStorage.setItem("bridgelands_detached_form_start", "1");
    ...
    return (
      ...
      >
        ...
        <p className="mt-3 text-sm text-text-primary">
          VIP registration is confirmed. You will receive priority notice when Bridgelands
          detached-home floor plans and pricing are released. There is no purchase obligation.
        </p>
      </div>
    );
  }
