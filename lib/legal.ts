...
export const PRIVACY_SECTIONS: { h2: string; paragraphs: string[] }[] = [
  {
    ...
    paragraphs: [
      `${SITE_ORG_NAME} publishes ${SITE_URL} as an independent information and registration resource focused on the potential detached-home collection at Bridgelands in Woodbridge, Vaughan, Ontario. This site is not the official website of Arista Homes, Deco Homes, or Opus Homes and is not affiliated with or endorsed by any of them.`,
    ],
  },
  {
    h2: "What is collected and why",
    paragraphs: [
      "When you submit the registration form, this site collects first name, last name, email address, telephone number, whether you are a licensed real estate agent, and a record of CASL consent. Those fields are used to notify registrants when detached-home floor plans, pricing, and related project details are released.",
  ...
  },
  {
    ...
    paragraphs: [
      `Registration records are retained for as long as they are needed to administer the Bridgelands detached-home VIP notification list, and for a reasonable period afterward to demonstrate CASL consent if a question arises, unless a shorter period is required by law. To request deletion of your personal information, email ${CONTACT_EMAIL} from the address you registered with, with the subject line “Privacy request”. Privacy Requests is a generic alias, not a personal inbox.`,
    ],
  },
  {
...
export const TERMS_SECTIONS: { h2: string; paragraphs: string[] }[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "A detached-home collection at Bridgelands has not been officially confirmed. Lot widths, sizes, garage configuration, pricing, deposit structure, occupancy, incentives, assignment policy, and which builder may be responsible for the detached portion are unpublished and must be verified at release. Comparable figures from SouthCal and The Castle Mile are context only, not Bridgelands specifications.",
    ],
  },
  {
    h2: "No legal, tax, or financial advice",
    paragraphs: [
      "Nothing on this site is legal, tax, or financial advice. Descriptions of deposits, occupancy, assignment, schools, and transit are general information compiled from publicly available sources. This site does not guarantee appreciation, allocation, or returns, and it does not guarantee that Bridgelands will include detached homes. Buyers should review any agreement of purchase and sale with their own lawyer and obtain their own advice before making a decision.",
    ],
  },
  {
    h2: "Registration",
