...
export function siteOrganizationSchema() {
  return {
    ...
    url: `${SITE_URL}/`,
    description:
      "An independent information resource focused on the potential detached-home collection at Bridgelands, not affiliated with or endorsed by Arista Homes, Deco Homes, or Opus Homes.",
  };
}
...
export function residenceSchema() {
  return {
    ...
    name: SITE_NAME,
    description:
      "An independent resource on the potential detached-home collection at Bridgelands, a Coming Soon community near Weston Road & Teston Road, Woodbridge, Vaughan, Ontario, by Arista Homes, Deco Homes, and Opus Homes.",
    url: `${SITE_URL}/`,
    ...
    additionalProperty: [
      ...
      },
      {
        "@type": "PropertyValue",
        name: "Home types",
        value: "Detached-home collection expected (unconfirmed)",
      },
      {
        "@type": "PropertyValue",
        name: "Pricing status",
...
export function imageObjectSchema() {
  return {
    ...
    caption: "Bridgelands detached-home collection rendering, Woodbridge, Vaughan, Ontario",
    description:
      "Illustrative rendering related to the expected Bridgelands detached-home collection.",
  };
}
