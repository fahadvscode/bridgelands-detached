  ...
  return (
    <>
      ...
      <Section labelledBy="answer">
        <AnswerFirstSummary heading="Where are Bridgelands detached homes located?">
          {LOCATION_ANSWER}
        </AnswerFirstSummary>
        <div className="mt-8">
          <AnswerFirstSummary heading="How do Bridgelands detached homes compare to SouthCal's?">
            {LOCATION_COMPARE_ANSWER}
          </AnswerFirstSummary>
        </div>
      </Section>
      ...
      <Section labelledBy="schools">
        <SectionHeading id="schools">Schools near Bridgelands detached homes</SectionHeading>
        <div className="mt-6">
          <Prose>
      ...
      <Section labelledBy="compare">
        <SectionHeading id="compare">
          Bridgelands detached homes vs. the trio&apos;s other detached-home communities
        </SectionHeading>
        ...
        <div className="mt-8">
          <Prose>
            {LOCATION_COMPARE_BODY.map((paragraph) => (
              <p key={paragraph.slice(0, 48)}>{paragraph}</p>
            ))}
          </Prose>
        </div>
