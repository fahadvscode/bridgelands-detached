...
export default function ThankYouPage() {
  ...
  return (
    <>
      ...
      <PageHeader
        h1={meta.h1}
        lede="You will be notified when Bridgelands detached-home floor plans and pricing are released. There is no purchase obligation."
      />
      <Section labelledBy="next">
        ...
        <p className="mt-4 max-w-[62ch] text-text-primary">
          ...
          including how a potential Bridgelands detached home compares with SouthCal and The Castle
          Mile.
        </p>
