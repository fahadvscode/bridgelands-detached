  ...
  return (
    <>
      ...
      <Section labelledBy="answer">
        <AnswerFirstSummary heading="How much do Bridgelands detached homes cost?">
          {PRICING_ANSWER}
        </AnswerFirstSummary>
        <div className="mt-8">
          <AnswerFirstSummary heading="Is there a deposit structure for Bridgelands detached homes?">
            {PRICING_DEPOSIT_ANSWER}
          </AnswerFirstSummary>
        </div>
      </Section>
      <Section alt labelledBy="status">
        ...
        <p className="mt-4 max-w-[62ch] text-text-muted">
          ...
          detached-home buyers can see the current status in one place rather than a gated sheet.
        </p>
        <div className="mt-8">
          <PricingTable />
        </div>
      ...
      <Section labelledBy="context">
        <SectionHeading id="context">How to read detached-home pricing before a launch</SectionHeading>
        <div className="mt-6">
          <Prose>
            ...
            <p>
              {UNVERIFIED_NOTE} Dollar amounts, deposit months, occupancy, lot premiums, and any
              assignment or parking credits should be treated as unconfirmed until they appear in a
              builder price list or an Agreement of Purchase and Sale.
            </p>
          </Prose>
        </div>
      </Section>
      <Section alt labelledBy="read">
        <SectionHeading id="read">What “to be announced” means for a detached buyer</SectionHeading>
        <div className="mt-6">
          <Prose>
            ...
            <p>
              <TextLink href="/register">
                Register to be notified when detached-home pricing is released
              </TextLink>
